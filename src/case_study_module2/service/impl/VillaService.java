...
public class VillaService {
    ...
    public static Villa infoVilla() {
        ...
        do {
            ...
            try {
                ...
                if (swimmingPoolArea < 30) {
                    throw new ExceptionFuruma("Diện tích hồ bơi phải lớn hơn 30 mét vuông!");
                }
                break;
            } catch (ExceptionFuruma e) {
                System.err.println(e.getMessage());
        ...
        return new Villa(serviceId, serviceName, usableArea, rentalCosts, maximumNumberOfPeople, rentalType, roomStandard, swimmingPoolArea, numberOfFloors);
    }
}
